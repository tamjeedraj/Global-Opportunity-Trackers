  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const oppRes = await axios.get("https://global-opportunity-trackers.onrender.com/api/opportunities");
        setOpportunities(oppRes.data);

        //const recRes = await axios.get("http://localhost:8000/api/recommendations");
        const recRes = await axios.get("https://global-opportunity-trackers.onrender.com/api/recommendations");
